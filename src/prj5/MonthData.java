...
public class MonthData implements Comparable<MonthData> {
     ...
     *            the month
     * @param followerCount
     *            amount of followers in this month
     * @param likes
     *            amount of likes
     * @param posts
     *            amount of posts
    ...
    public int compareTo(MonthData obj) {
        ...
        if (followerCount != obj.followerCount) {
            return Integer.compare(followerCount, obj.followerCount);
        }
        if (posts != obj.posts) {
            return Integer.compare(posts, obj.posts);
        }
        return Integer.compare(views, obj.views);
    }
